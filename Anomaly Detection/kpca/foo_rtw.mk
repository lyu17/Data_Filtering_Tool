...
## 
## Makefile     : foo_rtw.mk
## Generated on : Fri Oct 10 21:19:12 2014
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/foo.a
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/li/Documents/Fault\ Detection/Code/matlab
ARCH                      = maci64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/foo.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/codegen/lib/foo -I/Users/li/Documents/Fault -I$(START_DIR)/Detection/Code/matlab -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=foo -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/codegen/lib/foo/foo_initialize.c $(START_DIR)/codegen/lib/foo/foo_terminate.c $(START_DIR)/codegen/lib/foo/foo.c $(START_DIR)/codegen/lib/foo/rt_nonfinite.c $(START_DIR)/codegen/lib/foo/rtGetNaN.c $(START_DIR)/codegen/lib/foo/rtGetInf.c
...
OBJS = foo_initialize.o foo_terminate.o foo.o rt_nonfinite.o rtGetNaN.o rtGetInf.o
...
%.o : $(START_DIR)/codegen/lib/foo/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/foo/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
